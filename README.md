...
[openclaw](https://github.com/openclaw/openclaw) 上で動作し、毎朝6時（JST）に自動でニュースが流れ、Telegramにレポートが届く。
...
| エージェント | 役割 | 実行スケジュール |
|------------|------|----------------|
| 📰 Journalist | 実ニュースをWeb検索して投稿 | 毎日 JST 6:00 |
| 📢 Spreader | ニュースをタブロイド風に誇張 | 毎日 JST 6:10 |
| 👤 Citizen1 | 会社員。感情的見出しに流されやすい | 毎日 JST 6:20 |
| 👴 Citizen2 | 高齢者。政府・健康・お金に反応しやすい | 毎日 JST 6:25 |
| 🔍 Factchecker | 要検証記事をWeb検索で検証 | 無効（disabled） |
| 📊 Observer | 全体集計・レポート生成・Telegram通知 | 毎日 JST 6:50 |
